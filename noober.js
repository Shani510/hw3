function pageLoad() {
  ...
  // passenger1Name = ride[0].passengerDetails.first + ' ' +ride[0].passengerDetails.last // one option to write this
  if (ride.length == 1) {
passenger1Name = `${ride[0].passengerDetails.first} ${ride[0].passengerDetails.last}`
      console.log(passenger1Name) // note to self: can also write in () the entire thing above `${ride[0].passengerDetails.first} ${ride[0].passengerDetails.last}`
passenger1Phone = ride[0].passengerDetails.phoneNumber // do I need to use `${}` if I only have one element?
      console.log(passenger1Phone)
passenger1NumberOfPassengers = ride[0].numberOfPassengers // where do I see this info?
